...
public class Testing {
	...
	public void A2_TestDictionary_addWord() throws Exception{
		dic.addWord("format");
		assertEquals(String.format("[Error]: Invalid dictionary entry: 'format'%n"), outContent.toString());	
	}
	...
	public void A3_TestDictionary_addWord() throws Exception{
		...
		assertEquals(String.format("[Error]: Unsupported category: 'unknown'%n"), outContent.toString());	
	}
	...
	public void A5_TestDictionary_getWord()
	{
		for(String str:words1)
			dic.addWord(str);
		dic.getWord("pronoun");
		assertEquals(String.format("[Error]: No remaining words of category: 'pronoun'%n"), outContent.toString());	
	...
	public void A6_TestDictionary_getWord()
	{
		for(String str:words1)
			dic.addWord(str);
		dic.getWord("dummy");
		assertEquals(String.format("[Error]: Unsupported category: 'dummy'%n"), outContent.toString());
